...
; It was automatically generated from 'SDL3_mixer_Template.pbi' by 'SDLx_Build.pb'.
;
; Generated 2026-03-11 02:30:04 UTC
...
Global MIX_AudioFramesToMS.Proto_MIX_AudioFramesToMS
Global MIX_AudioMSToFrames.Proto_MIX_AudioMSToFrames
Global MIX_CreateAudioDecoder.Proto_MIX_CreateAudioDecoder
Global MIX_CreateAudioDecoder_IO.Proto_MIX_CreateAudioDecoder_IO
Global MIX_CreateGroup.Proto_MIX_CreateGroup
Global MIX_CreateMixer.Proto_MIX_CreateMixer
Global MIX_CreateMixerDevice.Proto_MIX_CreateMixerDevice
Global MIX_CreateSineWaveAudio.Proto_MIX_CreateSineWaveAudio
Global MIX_CreateTrack.Proto_MIX_CreateTrack
Global MIX_DecodeAudio.Proto_MIX_DecodeAudio
Global MIX_DestroyAudio.Proto_MIX_DestroyAudio
Global MIX_DestroyAudioDecoder.Proto_MIX_DestroyAudioDecoder
Global MIX_DestroyGroup.Proto_MIX_DestroyGroup
Global MIX_DestroyMixer.Proto_MIX_DestroyMixer
Global MIX_DestroyTrack.Proto_MIX_DestroyTrack
Global MIX_FramesToMS.Proto_MIX_FramesToMS
Global MIX_TagTrack.Proto_MIX_TagTrack
Global MIX_TrackFramesToMS.Proto_MIX_TrackFramesToMS
Global MIX_TrackMSToFrames.Proto_MIX_TrackMSToFrames
Global MIX_TrackPaused.Proto_MIX_TrackPaused
Global MIX_TrackPlaying.Proto_MIX_TrackPlaying
Global MIX_UnlockMixer.Proto_MIX_UnlockMixer
Global MIX_UntagTrack.Proto_MIX_UntagTrack
...
ImportC #SDLx_mixer_ImportLibraryName
  ...
  MIX_Quit()
  MIX_Version.l()
  MIX_AudioFramesToMS.q(*audio.MIX_Audio, frames.Sint64)
  MIX_AudioMSToFrames.q(*audio.MIX_Audio, ms.Sint64)
  MIX_CreateAudioDecoder.i(path.p-utf8, props.SDL_PropertiesID)
  MIX_CreateAudioDecoder_IO.i(*io.SDL_IOStream, closeio.Uint8, props.SDL_PropertiesID)
  MIX_CreateGroup.i(*mixer.MIX_Mixer)
  MIX_CreateMixer.i(*spec.SDL_AudioSpec)
  MIX_CreateMixerDevice.i(devid.SDL_AudioDeviceID, *spec.SDL_AudioSpec)
  MIX_CreateSineWaveAudio.i(*mixer.MIX_Mixer, hz.Sint32, amplitude.f, ms.Sint64)
  MIX_CreateTrack.i(*mixer.MIX_Mixer)
  MIX_DecodeAudio.l(*audiodecoder.MIX_AudioDecoder, *buffer, buflen.Sint32, *spec.SDL_AudioSpec)
  MIX_DestroyAudio(*audio.MIX_Audio)
  MIX_DestroyAudioDecoder(*audiodecoder.MIX_AudioDecoder)
  MIX_DestroyGroup(*group.MIX_Group)
  MIX_DestroyMixer(*mixer.MIX_Mixer)
  MIX_DestroyTrack(*track.MIX_Track)
  MIX_FramesToMS.q(sample_rate.Sint32, frames.Sint64)
  MIX_TagTrack.a(*track.MIX_Track, tag.p-utf8)
  MIX_TrackFramesToMS.q(*track.MIX_Track, frames.Sint64)
  MIX_TrackMSToFrames.q(*track.MIX_Track, ms.Sint64)
  MIX_TrackPaused.a(*track.MIX_Track)
  MIX_TrackPlaying.a(*track.MIX_Track)
  MIX_UnlockMixer(*mixer.MIX_Mixer)
  MIX_UntagTrack(*track.MIX_Track, tag.p-utf8)
    ...
    If (#True)
      ...
      If (__SDLx_MIX_Init)
        ...
        If (__SDLx_MIX_Quit)
          ...
          _SDLx_LoadFunction(MIX_Version)
          _SDLx_LoadFunction(MIX_AudioFramesToMS)
          _SDLx_LoadFunction(MIX_AudioMSToFrames)
          _SDLx_LoadFunction(MIX_CreateAudioDecoder)
          _SDLx_LoadFunction(MIX_CreateAudioDecoder_IO)
          _SDLx_LoadFunction(MIX_CreateGroup)
          _SDLx_LoadFunction(MIX_CreateMixer)
          _SDLx_LoadFunction(MIX_CreateMixerDevice)
          _SDLx_LoadFunction(MIX_CreateSineWaveAudio)
          _SDLx_LoadFunction(MIX_CreateTrack)
          _SDLx_LoadFunction(MIX_DecodeAudio)
          _SDLx_LoadFunction(MIX_DestroyAudio)
          _SDLx_LoadFunction(MIX_DestroyAudioDecoder)
          _SDLx_LoadFunction(MIX_DestroyGroup)
          _SDLx_LoadFunction(MIX_DestroyMixer)
          _SDLx_LoadFunction(MIX_DestroyTrack)
          _SDLx_LoadFunction(MIX_FramesToMS)
          _SDLx_LoadFunction(MIX_TagTrack)
          _SDLx_LoadFunction(MIX_TrackFramesToMS)
          _SDLx_LoadFunction(MIX_TrackMSToFrames)
          _SDLx_LoadFunction(MIX_TrackPaused)
          _SDLx_LoadFunction(MIX_TrackPlaying)
          _SDLx_LoadFunction(MIX_UnlockMixer)
          _SDLx_LoadFunction(MIX_UntagTrack)
